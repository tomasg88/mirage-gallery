export const curatedAbi = [
  ...
  },
  {
    ...
    inputs: [
      {
        name: '_miragePercentage',
        type: 'uint256',
      },
    ],
    name: 'updateMiragePercentage',
    outputs: [],
    payable: false,
    stateMutability: 'nonpayable',
    type: 'function',
